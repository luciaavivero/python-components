...
HUMO_ACTUATOR_NAME       = 'HumoActuator'
...
DEFAULT_CONFIG_FILE_NAME = '/home/luciaavivero/programmingtheiot/python-components/config/PiotConfig.props'
...
HUMO_SIM_FLOOR_KEY = 'humoSimFloor'
HUMO_SIM_CEILING_KEY = 'humoSimCeiling'
