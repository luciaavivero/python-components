...
class ActuatorAdapterManager(object):
	...
	def __init__(self, dataMsgListener: IDataMessageListener = None):
		...
		self.deviceID = self.configUtil.getProperty(section = ConfigConst.CONSTRAINED_DEVICE, key = ConfigConst.DEVICE_LOCATION_ID_KEY, defaultVal = ConfigConst.NOT_SET)
